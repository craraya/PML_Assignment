...
```{r}
library(caret)
pml_training <- read.csv("/media/caraya/DATA/CURSOS/02-Datascience/08 - Practical_Machine_Learning/Assignment/pml-training.csv", na.strings = c("", "NA", "#DIV/0!"))
pml_testing <- read.csv("/media/caraya/DATA/CURSOS/02-Datascience/08 - Practical_Machine_Learning/Assignment/pml-testing.csv", na.strings = c("", "NA", "#DIV/0!"))
